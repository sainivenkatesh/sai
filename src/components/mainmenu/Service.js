...
function Service() {
    ...
    return(<>
        ...
        <p className="para" >lorem In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate 
            ...
            used as a placeholder before final copy is available. It is also used to temporarily replace text in a
             ...
             the meaning of the text influencing the design</p>
